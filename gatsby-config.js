...
module.exports = {
  ...
  plugins: [
        ...
        feeds: [
          {
            ...
            output: "/rss.xml",
            title: "Securitypedant Blog RSS Feed",
          },
        ],
      },
    },
    {
      ...
      options: {
        name: `Securitypedant Blog`,
        short_name: `securitypedant`,
        start_url: `/`,
        ...
        // theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/securitypedant-logo-small.png`, // This path is relative to the root of the site.
      },
    },
  ],
}
